...
public sealed class Plugin : IDalamudPlugin
{
        ...
        IDtrBar dtrBar)
    {
        ...
        _statusWindow = new StatusWindow(_config, _store, _localizer, _sync, _inventorySync, _weeklySync, RequestManualPush, RequestInventorySync, RequestWeeklySync, OpenConfig, OpenBis, OpenAdvisor, OpenLog, OpenReport, OpenTeams, OpenCalendar, OpenPreview, OpenWhatsNew);
    ...
    private void OpenReport() => _reportWindow.Open();
    ...
    private ContactClient DescribeClient(string? where)
    {
        ...
        return new ContactClient
        {
            ...
            PluginVersion = ProtocolConstants.PluginVersion,
