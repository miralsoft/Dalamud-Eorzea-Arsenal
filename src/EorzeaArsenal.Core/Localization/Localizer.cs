...
public sealed class Localizer : ILocalizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [LocKeys.AdvisorNoPlan] = "No own plan saved for this set. Build one in the web advisor — it then shows up here.",
        ...
        [LocKeys.AdvisorEditPending] = "Editing the plan in game follows once the server sends the choices per slot.",
    ...
    private static readonly IReadOnlyDictionary<string, string> De = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [LocKeys.AdvisorNoPlan] = "Für dieses Set ist kein eigener Plan gespeichert. Lege ihn im Kaufberater der Webapp an — er erscheint dann hier.",
        ...
        [LocKeys.AdvisorEditPending] = "Den Plan im Spiel bearbeiten folgt, sobald der Server die Auswahl pro Slot mitliefert.",
