...
public sealed class Localizer : ILocalizer
{
    ...
    private static readonly IReadOnlyDictionary<string, string> En = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [LocKeys.TeamsFarmColCost] = "Cost",
        [LocKeys.TeamsFarmColWhere] = "Where",
        [LocKeys.TeamsFarmBooks] = "books",
        [LocKeys.TeamsFarmTokens] = "tokens",
        [LocKeys.TeamsFarmFloor] = "Floor {0}",
        [LocKeys.TeamsFarmVendor] = "Vendor",
        [LocKeys.TeamsFarmUpgrade] = "Upgrade",
    ...
    private static readonly IReadOnlyDictionary<string, string> De = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [LocKeys.TeamsFarmColCost] = "Kosten",
        [LocKeys.TeamsFarmColWhere] = "Woher",
        [LocKeys.TeamsFarmBooks] = "Bücher",
        [LocKeys.TeamsFarmTokens] = "Marken",
        [LocKeys.TeamsFarmFloor] = "Ebene {0}",
        [LocKeys.TeamsFarmVendor] = "Händler",
        [LocKeys.TeamsFarmUpgrade] = "Aufwertung",
